...
```text
Cargo package: neurovirtual-hardware
Rust module:   device::bwiii::position
Type:          Position
```
...
```python
from neurovirtual.hardware.device.bwiii.position import Position
```

```typescript
import type { Position } from "@neurovirtual/core/hardware/device/bwiii/position";
```
