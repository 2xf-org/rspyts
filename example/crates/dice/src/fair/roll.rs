//! Repeatable rolls for fair dice.
...
pub enum RollError {
    ...
    InvalidRequest,
    #[error("the summary label cannot be empty")]
    EmptyLabel,
}

/// A repeatable source of fair dice rolls.
pub struct DiceCup {
    sides: u32,
    state: u64,
}
...
impl DiceCup {
    ...
    /// # Errors
    ///
    /// Returns [`RollError::InvalidRequest`] if `sides` is not from 2 through 100.
    #[rspyts(constructor)]
...
/// The default seed for a fair roll.
#[rspyts::export]
