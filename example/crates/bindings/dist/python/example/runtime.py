...
native_schemas: dict[str, Any] = {
    "example-dice::example_dice::DiceReport": ("struct", {"summary": ("named", "example-dice::example_dice::summary::RollSummary")}),
    "example-dice::example_dice::fair::roll::RollMode": None,
